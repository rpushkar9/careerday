...
const roadmapData: RoadmapData = {
  major: 'Accounting (Business Track)',
  university: 'Queens College',
  totalDegreeCredits: 40, // Major-specific credits :contentReference[oaicite:1]{index=1}
  totalDegreeCost: 20000, // Estimate as needed
  years: {
    year1: {
      totalCost: 18000,
      fall: {
        ...
        tuition: 7500,
        courses: [
          { code: 'ENGL110', name: 'English Composition I', credits: 3 },
          { code: 'ECON101', name: 'Intro to Macroeconomics', credits: 3 },
          { code: 'ACCT101', name: 'Accounting I', credits: 3 },
          { code: 'WCGI', name: 'World Cultures & Global Issues', credits: 3 },
          { code: 'CE', name: 'Creative Expression', credits: 3 },
        ],
        opportunities: ['Join ALPFA or NABA', 'Networking event with alumni'],
        volunteerWork: ['Peer tutoring in accounting basics'],
        internships: ['On-campus accounting assistant'],
        projects: ['Personal finance budgeting case study'],
      },
      spring: {
        totalCredits: 16,
        tuition: 8000,
    ...
    year2: {
      // Continue with sophomore courses from QC plan:
      fall: {
        totalCredits: 16,
        tuition: 8000,
        courses: [
          { code: 'ACCT201', name: 'Intermediate Accounting I', credits: 4 },
          { code: 'BUS241', name: 'Corporation Finance', credits: 3 },
          { code: 'CSCI48', name: 'Spreadsheet Programming', credits: 3 },
      ...
      spring: {
        ...
        tuition: 8500,
        courses: [
          { code: 'ACCT202', name: 'Intermediate Accounting II', credits: 2 },
          { code: 'ACCT305', name: 'Cost Accounting', credits: 2 },
          { code: 'ECON249', name: 'Statistics for Econ/Business', credits: 3 },
    ...
    year3: {
      ...
      fall: {
        ...
        tuition: 8000,
        courses: [
          { code: 'ACCT367', name: 'Federal & NY State Taxes', credits: 4 },
          { code: 'ACCT321', name: 'Auditing I', credits: 3 },
